...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BookmarkInstance.url'
        db.add_column('bookmarks_bookmarkinstance', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BookmarkInstance.url'
        db.delete_column('bookmarks_bookmarkinstance', 'url')
    ...
    models = {
        ...
        'bookmarks.bookmark': {
            ...
            'adder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'added_bookmarks'", 'null': 'True', 'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'favicon_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'has_favicon': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

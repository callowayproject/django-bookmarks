...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bookmarks_bookmark', (
            ...
            ('has_favicon', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('favicon_checked', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('adder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='added_bookmarks', null=True, to=orm['auth.User'])),
